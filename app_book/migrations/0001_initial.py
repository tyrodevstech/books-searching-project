    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('User', 'User'), ('Shop Owner', 'Shop Owner')], default='User', max_length=122, null=True)),
                ('otp', models.CharField(blank=True, max_length=122, null=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='profile_picture/%Y/%d/%b')),
